package com.curso.algasensors.temperature.monitoring.api.controller;

import com.curso.algasensors.temperature.monitoring.api.model.SensorMonitoringOuput;
...
public class SensorMonitoringController {
    ...
    public void enable(@PathVariable TSID sensorId) {
        SensorMonitoring sensorMonitoring = findByIdOrDefault(sensorId);
        if(Boolean.TRUE.equals(sensorMonitoring.getEnabled())) throw new ResponseStatusException(HttpStatus.UNPROCESSABLE_ENTITY);
